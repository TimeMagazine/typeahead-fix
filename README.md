_This is a clone of an old version of Typeahead with a few small modifications, retrofitted to work with Browserify. We need to eventually find a better solution for autocompletion._
